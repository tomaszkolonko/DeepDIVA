"""
Taken form: https://github.com/isht7/pytorch-deeplab-resnet/blob/master/deeplab_resnet.py
"""
...
class ResNet(nn.Module):
    def __init__(self, block, layers, NoLabels):
        ...
        self.layer5 = self._make_pred_layer(ClassifierModule, [6, 12, 18, 24], [6, 12, 18, 24], NoLabels)
...
class MS_Deeplab(nn.Module):
    def __init__(self, block, no_labels):
        super(MS_Deeplab,self).__init__()
        self.Scale = ResNet(block, [3, 4, 23, 3], no_labels)   #changed to fix #4
