...
def apply(data_loader, model, criterion, writer, epoch, class_names, dataset_folder, inmem, workers, runner_class, use_boundary_pixel, no_cuda=False, log_interval=10, **kwargs):
    """
