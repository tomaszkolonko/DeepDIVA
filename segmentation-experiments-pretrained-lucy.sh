...
python ./template/RunMe.py --runner-class semantic_segmentation_hisdb --dataset-folder /data/ltp/HisDB-private/CB55/ --model-name fcdensenet57 --epochs 50 --experiment-name segmentation --output-folder ../output/ --decay-lr 24 \
 ...
 --path-pretrained-model /home/linda/output/coco/coco2017/model_name=Unet/batch_size=16/epochs=50/lr=0.01/momentum=0.9/gpu_id=0/workers=16/no_val_conf_matrix=True/resize_coco=320/22-02-19-14h-49m-36s/model_best.pth.tar
