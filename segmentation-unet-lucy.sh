...
python ./template/RunMe.py --runner-class semantic_segmentation_hisdb --dataset-folder /data/ltp/HisDB-private/CB55/ --model-name unet --epochs 50 --experiment-name test --output-folder ../output/ --decay-lr 24 \
 ...
 --path-pretrained-model /home/linda/output/coco/coco2017/model_name=unet/batch_size=10/epochs=50/lr=0.02/momentum=0.9/gpu_id=1/workers=16/no_val_conf_matrix=True/resize_coco=320/20-02-19-13h-32m-49s/model_best.pth.tar
