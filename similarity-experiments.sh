...
# Densenet121 ---------------------------------------
python ./template/RunMe.py --runner-class triplet --dataset-folder ../datasets/historical_wi/ColoredDataset/ --model-name densenet121 --epochs 15 --experiment-name similarity-opt-multicrop --output-folder ../output/ --decay-lr 12 --n-triplets 1500000 --output-channels 128 --map auto --ignoregit --batch-size 32 --regenerate-every 1 --lr 0.03354 --momentum 0.21808 --weight-decay 0.00231 -j 16 --gpu-id 1
